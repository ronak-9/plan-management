    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form id="edit-form" method="POST" action="{{ route('eligibility.criteria.update',$data['id']) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="age_less_than" name="age_less_than"
                                value="{{ old('age_less_than') ?? $data['age_less_than'] }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="age_greater_than" name="age_greater_than"
                                value="{{ old('age_greater_than') ?? $data['age_greater_than'] }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="last_login_days_ago" name="last_login_days_ago"
                                value="{{ old('last_login_days_ago') ?? $data['last_login_days_ago'] }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="income_less_than"
                                name="income_less_than" value="{{ old('income_less_than') ?? $data['income_less_than'] }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="income_greater_than"
                                name="income_greater_than" value="{{ old('income_greater_than') ?? $data['income_greater_than'] }}">
                        </div>
